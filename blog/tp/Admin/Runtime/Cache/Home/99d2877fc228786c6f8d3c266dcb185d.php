                    ...
                    <div class="templatemo-content-widget white-bg">
                        ...
                        <form class="layui-form layui-form-pane" action="<?php echo U('Sort/upd');?>" method="post" >
                            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                                <input type="hidden" name="id" value="<?php echo ($li['sort_id']); ?>" >
                                    ...
                                    <div class="layui-tab-item layui-show">
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                ...
                                                <input type="text" name="sort_name" value="<?php echo ($li['sort_name']); ?>" lay-verify="required" placeholder="请输入分类名称" autocomplete="off" class="layui-input">
