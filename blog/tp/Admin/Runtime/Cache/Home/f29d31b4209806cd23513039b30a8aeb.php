	...
	<div class="templatemo-top-nav-container">
                ...
                <div class="templatemo-content-container">
                    ...
                    <div class="templatemo-content-widget white-bg">
                        ...
                        <form class="layui-form layui-form-pane" id="signupForm" action="<?php echo U('Article/upd');?>" method="post" >
                            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                                <input type="hidden" name="id" value="<?php echo ($li['article_id']); ?>" >
                                    ...
                                    <div class="layui-tab-item layui-show">
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="article_title" id="article_title" lay-verify="required" placeholder="请输入分类名称" autocomplete="off" class="layui-input" value="<?php echo ($li['article_title']); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <!-- <div class="layui-input-inline"> -->
                                                   <?php if(is_array($label)): foreach($label as $k=>$v): ?><input type="checkbox" name="label[]" value="<?php echo ($v['label_name']); ?>"  <?php if($li['label'][$k]['label_id'] == $v['label_id']){echo checked;} ?>><?php echo ($v["label_name"]); ?>&nbsp;&nbsp;<?php endforeach; endif; ?>
                                            <!-- </div> -->
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <select name="sort">
                                                    <option value="<?php echo ($li['sort']); ?>"><?php echo ($li['sort']); ?></option>
                                        ...
                                        <div class="layui-form-item layui-form-text" id="setcontent">
                                            ...
                                            <div class="layui-input-block ">
                                                <textarea id="article_content" name="article_content" ><?php echo ($li['article_content']); ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                ...
                                                <?php if($li['yu']==1){?>
                                                    <input type="radio" value="1" name="yn" checked>是<input type="radio" value="0" name="yn">否 
                                                <?php }else{?>
                                                    <input type="radio" value="1" name="yn">是<input type="radio" value="0" name="yn" checked>否 
                                                <?php }?>
