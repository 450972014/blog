	...
	<div class="templatemo-sidebar">
                ...
                <nav class="templatemo-left-nav">
                    <ul class="layui-nav layui-nav-tree ">
                        <li class="layui-nav-item"><a href="/blog/tp/index.php/Home/Personal/index"><i class="layui-icon" style="top: 3px;">&#xe609; </i>系统首页</a></li>
...
<body>
	<div class="templatemo-top-nav-container">
                    <div class="row">
                        <nav class="templatemo-top-nav col-lg-12 col-md-12">
                            <ul class="text-uppercase">
                                ...
                                <li><a href="/blog/tp/index.php/Home/Personal/add_article" >发表新作</a></li>
        ...
        <script type="text/javascript">
            ...
            upload.render({
                elem: '#file',
                url: '/admin.php/Personal/uploadFile', //必填项
