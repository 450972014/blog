	...
	<div class="templatemo-sidebar">
                ...
                <nav class="templatemo-left-nav">
                    <ul class="layui-nav layui-nav-tree ">
                        <li class="layui-nav-item"><a href="/blog/tp/index.php/Home/Config/index"><i class="layui-icon" style="top: 3px;">&#xe609; </i>系统首页</a></li>
	...
	<div class="templatemo-top-nav-container">
                    <div class="row">
                        <nav class="templatemo-top-nav col-lg-12 col-md-12">
                            <ul class="text-uppercase">
                                ...
                                <li><a href="/blog/tp/index.php/Home/Config/add_article" >发表新作</a></li>
                ...
                <div class="templatemo-content-container">
                    ...
                    <div class="templatemo-content-widget white-bg">
                        ...
                        <form class="layui-form layui-form-pane" id="signupForm" action="<?php echo U('Config/save');?>" method="post" >
                                    ...
                                    <div class="layui-tab-item layui-show">
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="web_site" id="web_site" lay-verify="required"
                                                value="<?php echo ($data['web_site']); ?>"    autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="web_miao" id="web_miao" value="<?php echo ($data['web_miao']); ?>" lay-verify="required"  autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="qq" id="qq" value="<?php echo ($data['qq']); ?>" lay-verify="required"  autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                            <label class="layui-form-label">联系电话</label>
                                            <div class="layui-input-inline">
                                                <input type="text" name="tel" id="tel" value="<?php echo ($data['tel']); ?>" lay-verify="required"  autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                            ...
                            <div class="layui-form-item">
                                <div class="layui-input-block">
                                    <input type="submit" class="layui-btn" id="" value="提交"></input>
