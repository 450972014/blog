	...
	<div class="templatemo-sidebar">
                ...
                <nav class="templatemo-left-nav">
                    <ul class="layui-nav layui-nav-tree ">
                        <li class="layui-nav-item"><a href="/blog/tp/index.php/Home/Sort/index"><i class="layui-icon" style="top: 3px;">&#xe609; </i>系统首页</a></li>
                    ...
                    <div class="row">
                        <nav class="templatemo-top-nav col-lg-12 col-md-12">
                            <ul class="text-uppercase">
                                ...
                                <li><a href="/blog/tp/index.php/Home/Sort/add_article" >发表新作</a></li>
                        ...
                        <div class="col-1">
                            <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                                <div class="panel-heading templatemo-position-relative">
                                    <h2 class="text-uppercase">分类管理  <a href="<?php echo U('Sort/sort_add');?>"><i class="layui-icon left15 " style="font-size: 18px; color: #fff;">&#xe654;</i></a>  </h2>
                                </div>
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo U('Sort/save')?>?id=<?php echo ($v["sort_id"]); ?>">修改</a>
                                                    <a href="<?php echo U('Sort/sort_del')?>?id=<?php echo ($v["sort_id"]); ?>" >删除</a>
                                                </td>
        ...
        <script>
            ...
            $('.dele_article').click(function () {
                ...
                layer.confirm('确认删除该文章？', {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/blog/tp/index.php/Home/Sort/dele_article",
                        data: {id: article_id},
                        dataType: "json",
                        beforeSend: function () {
