...
<html>
    <head>
        ...
        <title>M-finder Home 后台管理系统 - 首页</title>
                    ...
                    <ul class="layui-nav layui-nav-tree "> 
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd><a href="/blog/tp/index.php/Home/Admin/menu_list">栏目管理</a></dd>
                    ...
                    <div class="row">
                        <nav class="templatemo-top-nav col-lg-12 col-md-12">
                            <ul class="text-uppercase">
                                ...
                                <li><a href="<?php echo U('Article/add_article');?>" >发表新作</a></li>
                                <li><a href="<?php echo U('Admin/p_update');?>">资料修改</a></li>
                        ...
                        <div class="templatemo-content-widget white-bg col-1">
                            <div class="media margin-bottom-30">
                                <div class="media-left padding-right-25">
                                    <a href="#">
                                        <img class="media-object img-circle templatemo-img-bordered" src="/blog/tp/Public/Upload/avatar/<<?php echo ((isset($info["avatar"]) && ($info["avatar"] !== ""))?($info["avatar"]):'none.jpg'); ?>>" alt="Sunset" style="max-width:120px;">
                                    </a>
                                </div>
...
<!--                                        <tr>
        ...
        <script>
            ...
            $('.sign').change(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "/blog/tp/index.php/Home/Admin/edit_sign",
                    data: {sign: sign},
                    dataType: "json",
                    beforeSend: function () {
