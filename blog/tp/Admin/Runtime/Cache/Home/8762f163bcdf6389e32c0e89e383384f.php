	...
	<div class="templatemo-top-nav-container">
                ...
                <div class="templatemo-content-container">
                    ...
                    <div class="templatemo-content-widget white-bg">
                        ...
                        <form class="layui-form layui-form-pane" action="<?php echo U('Link/upd');?>" method="post" >
                            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                                <input type="hidden" name="id" value="<?php echo ($li['link_id']); ?>" >
                                    ...
                                    <div class="layui-tab-item layui-show">
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                ...
                                                <input type="text" name="link_name" value="<?php echo ($li['link_name']); ?>" lay-verify="required" placeholder="请输入分类名称" autocomplete="off" class="layui-input">
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="link_url" id="link_url" lay-verify="required" placeholder="请输入分类名称" autocomplete="off" class="layui-input" value="<?php echo ($li['link_url']); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
