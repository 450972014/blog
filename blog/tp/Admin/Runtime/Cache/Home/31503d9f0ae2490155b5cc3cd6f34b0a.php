	...
	<div class="templatemo-sidebar">
                ...
                <nav class="templatemo-left-nav">
                    <ul class="layui-nav layui-nav-tree ">
                        <li class="layui-nav-item"><a href="/blog/tp/index.php/Home/User/index"><i class="layui-icon" style="top: 3px;">&#xe609; </i>系统首页</a></li>
                    ...
                    <div class="row">
                        <nav class="templatemo-top-nav col-lg-12 col-md-12">
                            <ul class="text-uppercase">
                                ...
                                <li><a href="/blog/tp/index.php/Home/User/add_article" >发表新作</a></li>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo U('User/save')?>?id=<?php echo ($v["user_id"]); ?>">修改</a>
                                                    <a href="<?php echo U('User/del')?>?id=<?php echo ($v["user_id"]); ?>" class="del" >删除</a>
                                                </td>
        ...
        <script>
            ...
            $('.del').click(function () {
                ...
                layer.confirm('确认删除该文章？', {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/blog/tp/index.php/Home/User/del",
                        data: {id: article_id},
                        dataType: "json",
                        beforeSend: function () {
