                        ...
                        <div class="col-1">
                            <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                                <div class="panel-heading templatemo-position-relative">
                                    <h2 class="text-uppercase">分类管理  <a href="<?php echo U('Label/label_add');?>"><i class="layui-icon left15 " style="font-size: 18px; color: #fff;">&#xe654;</i></a>  </h2>
                                </div>
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo U('Label/save')?>?id=<?php echo ($v["label_id"]); ?>">修改</a>
                                                    <a href="<?php echo U('Label/label_del')?>?id=<?php echo ($v["label_id"]); ?>" >删除</a>
                                                </td>
        ...
        <script>
            ...
            $('.dele_article').click(function () {
                ...
                layer.confirm('确认删除该文章？', {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/blog/tp/index.php/Home/Label/dele_article",
                        data: {id: article_id},
                        dataType: "json",
                        beforeSend: function () {
