	...
	<div class="templatemo-top-nav-container">
                ...
                <div class="templatemo-content-container">
                    ...
                    <div class="templatemo-content-widget white-bg">
                        ...
                        <form class="layui-form layui-form-pane" id="signupForm" action="<?php echo U('Sort/sortadd');?>" method="post" >
                                    ...
                                    <div class="layui-tab-item layui-show">
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="sort_name" id="sort_name" lay-verify="required" placeholder="请输入分类名称" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                    </div>
