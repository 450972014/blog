                ...
                <nav class="templatemo-left-nav">          
                    <ul class="layui-nav layui-nav-tree "> 
                        ...
                        <li class="layui-nav-item layui-nav-itemed">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="layui-this"><a href="<?php echo U('Admin/show');?>">管理员展示</a></dd>
                            </dl>
                        </li>
            ...
            <div class="templatemo-content col-1 light-gray-bg">
                    ...
                    <div class="row">
                        <nav class="templatemo-top-nav col-lg-12 col-md-12">
                            <ul class="text-uppercase">
                                ...
                                <li><a href="/blog/tp/index.php/Home/Admin/info_set">资料修改</a></li>
                                <li><a href="/blog/tp/Home/Index/index" target="_blank">博客首页</a></li>
                                <li><a href="/blog/tp/index.php/Home/Admin/logout">退出登录</a></li>
                            </ul>   
                        </nav> 
                    </div>
                </div>
                ...
                <div class="templatemo-content-container">
                    ...
                    <div class="templatemo-content-widget white-bg">
                        ...
                        <form class="layui-form layui-form-pane" action="<?php echo U('Sort/upd');?>" method="post" >
                            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                                <input type="hidden" name="id" value="<?php echo ($li['admin_id']); ?>" >
                                    ...
                                    <div class="layui-tab-item layui-show">
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="admin_name" value="<?php echo ($li['admin_name']); ?>" lay-verify="required" placeholder="请输入分类名称" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="admin_pwd" value="<?php echo ($li['admin_pwd']); ?>" lay-verify="required" placeholder="请输入分类名称" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                    </div>
