                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo U('Admin/save')?>?id=<?php echo ($v["admin_id"]); ?>">修改</a>
                                                    <a href="<?php echo U('Admin/del')?>?id=<?php echo ($v["admin_id"]); ?>" >删除</a>
                                                </td>
        ...
        <script>
            ...
            $('.dele_article').click(function () {
                ...
                layer.confirm('确认删除该文章？', {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/blog/tp/index.php/Home/Admin/dele_article",
                        data: {id: article_id},
                        dataType: "json",
                        beforeSend: function () {
