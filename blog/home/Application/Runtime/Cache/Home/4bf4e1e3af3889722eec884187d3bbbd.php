<?php if (!defined('THINK_PATH')) exit();?>﻿<!--
 ...
 -->
   <link href="/blog/home/Public/css/about.css" rel="stylesheet" />
<!DOCTYPE html>
...
<head>
    ...
    <link rel="shortcut icon" href="/blog/home/Public/images/Logo_40.png" type="image/x-icon">
    <!--Layui-->
    <link href="/blog/home/Public/css/layui.css" rel="stylesheet" />
    <!--font-awesome-->
    <link href="/blog/home/Public/css/font-awesome.min.css" rel="stylesheet" />
    <!--全局样式表-->
    <link href="/blog/home/Public/css/global.css" rel="stylesheet" />
    <!-- 本页样式表 -->
    <link href="/blog/home/Public/css/home.css" rel="stylesheet" />
</head>
<body>
    <!-- 导航 -->
    <nav class="blog-nav layui-header">
        <div class="blog-container">
            ...
            <a href="javascript:;" class="blog-user layui-hide">
                <img src="/blog/home/Public/images/Absolutely.jpg" alt="Absolutely" title="Absolutely" />
            </a>
            <!-- 不落阁 -->
            <a class="blog-logo" href="/blog/home/Public/home.html">不落阁</a>
            <!-- 导航菜单 -->
    ...
    <ul class="layui-nav layui-nav-tree layui-nav-side blog-nav-left layui-hide" lay-filter="nav">
        <li class="layui-nav-item layui-this">
            <a href="/blog/home/Public/home.html"><i class="fa fa-home fa-fw"></i>&nbsp;网站首页</a>
        </li>
        <li class="layui-nav-item">
            <a href="/blog/home/Public/article.html"><i class="fa fa-file-text fa-fw"></i>&nbsp;文章专栏</a>
        </li>
        <li class="layui-nav-item">
            <a href="/blog/home/Public/resource.html"><i class="fa fa-tags fa-fw"></i>&nbsp;资源分享</a>
        </li>
        <li class="layui-nav-item">
            <a href="/blog/home/Public/timeline.html"><i class="fa fa-road fa-fw"></i>&nbsp;点点滴滴</a>
        </li>
        <li class="layui-nav-item">
            <a href="/blog/home/Public/about.html"><i class="fa fa-info fa-fw"></i>&nbsp;关于本站</a>
        </li>
    </ul>
    ...
    <!-- layui.js -->
    <script src="/blog/home/Public/plug/layui/layui.js"></script>
    <!-- 全局脚本 -->
    <script src="/blog/home/Public/js/global.js"></script>
    <!-- 本页脚本 -->
    <script src="/blog/home/Public/js/about.js"></script>
</body>
</html>